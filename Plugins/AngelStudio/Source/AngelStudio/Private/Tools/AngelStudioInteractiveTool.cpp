...
#include "AngelStudioInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UAngelStudioInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UAngelStudioInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UAngelStudioInteractiveTool* NewTool = NewObject<UAngelStudioInteractiveTool>(SceneState.ToolManager);
...
UAngelStudioInteractiveToolProperties::UAngelStudioInteractiveToolProperties()
{
...
void UAngelStudioInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UAngelStudioInteractiveTool::Setup()
{
	...
	Properties = NewObject<UAngelStudioInteractiveToolProperties>(this, "Measurement");
...
void UAngelStudioInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UAngelStudioInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UAngelStudioInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UAngelStudioInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UAngelStudioInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UAngelStudioInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UAngelStudioInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UAngelStudioInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UAngelStudioInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
