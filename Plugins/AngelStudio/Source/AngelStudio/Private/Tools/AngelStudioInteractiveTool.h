...
#include "AngelStudioInteractiveTool.generated.h"


/**
 * Builder for UAngelStudioInteractiveTool
 */
UCLASS()
class ANGELSTUDIO_API UAngelStudioInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UAngelStudioInteractiveTool
 */
UCLASS(Transient)
class ANGELSTUDIO_API UAngelStudioInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UAngelStudioInteractiveToolProperties();
...
/**
 * UAngelStudioInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ANGELSTUDIO_API UAngelStudioInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAngelStudioInteractiveToolProperties> Properties;
